...
def save_btn(call):
    ...
    bot.answer_callback_query(call.id, text='Данные сохранениы')
...
def save_btn(call):
    ...
    chat_id = message.chat.id
    message_id = message.message_id
    bot.edit_message_text(chat_id=chat_id, message_id=message_id, text=f'Изменение данных.')
